...
void Request::AddHeaders(const MessageHeader &mh)
{
...
std::shared_ptr<SIPMessage> Request::genReply(int code)
{
...
bool Request::_equal(const SIPMessage &other) const
{
...
Request::MessageType Request::type() const
{
